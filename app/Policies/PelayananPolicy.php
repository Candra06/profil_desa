...
class PelayananPolicy
{
    ...
    {
        return $user->hasPermissionTo('list pelayanans');
    }
    ...
    {
        return $user->hasPermissionTo('view pelayanans');
    }
    ...
    {
        return $user->hasPermissionTo('create pelayanans');
    }
    ...
    {
        return $user->hasPermissionTo('update pelayanans');
    }
    ...
    {
        return $user->hasPermissionTo('delete pelayanans');
    }
