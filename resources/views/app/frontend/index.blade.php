                ...
                <div class="row">
                    <div class="col-md-7 highlight">
                        <div class="row">
                            <div class="col-md-7">
                                <img class="lazy"
                                    src="{{ asset(str_replace('public', 'storage', $artikel['thumbnail'])) }}"
                                    height="90%" width="100%" alt="">
                            </div>
                            <div class="col-md-5">
                                <p>{{ $artikel->created_at }}</p>
                                <h3>{{ $artikel->judul }} </h3>
                                {!! Str::limit($artikel->konten, 200) !!}
                                <br>
                    ...
                    <div class="col-md-5 mt-4">
                        @foreach ($artikels as $item)
                            <div class="row">
                                <div class="col-md-5">
                                    <img class="lazy" src="{{asset(str_replace('public', 'storage', $item['thumbnail']))}}" height="80%" width="100%"
                                        alt="">
                                </div>
                                <div class="col-md-7 ">
                                    <p>{{$item->created_at}}</p>
