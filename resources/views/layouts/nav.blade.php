                ...
                @auth
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                            ...
                            @endcan
                            @can('view-any', App\Models\GaleriDusun::class)
                            <a class="dropdown-item" href="{{ route('galeri-dusuns.index') }}">Galeri Dusuns</a>
                            @endcan
                            @can('view-any', App\Models\Pelayanan::class)
                            <a class="dropdown-item" href="{{ route('pelayanans.index') }}">Pelayanans</a>
                            @endcan
